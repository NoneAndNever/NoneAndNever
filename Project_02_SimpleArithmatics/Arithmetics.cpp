...
void Arithmetics::string_to_equation(std::string str)
{
...
void Arithmetics::string_with_space_to_equation(std::string str)
{
...
void Arithmetics::string_without_space_to_equation(std::string str)
{
	int i = 0;
	int j = i;
	for (; i < str.length(); i++) {
...
std::string Arithmetics::equation_to_string() const
{
	std::string s;
...
Number Arithmetics::calculate_in_brace(std::vector<Number>::iterator& it_num,
